#!/bin/bash
#SBATCH --job-name=llf_mindchat_qwen2_05b_lora
#SBATCH --output=llf_mindchat_qwen2_05b_lora_%j.out
#SBATCH --error=llf_mindchat_qwen2_05b_lora_%j.err
...
${PYTHON} -m llamafactory.cli train /share/home/gpu093197/zanewang/project-llm/llamafactory/configs/train_mindchat_qwen2_05b_lora.yaml
