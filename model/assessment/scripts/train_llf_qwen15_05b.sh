#!/bin/bash
#SBATCH --job-name=llf_qwen15_05b_lora
#SBATCH --output=llf_qwen15_05b_lora_%j.out
#SBATCH --error=llf_qwen15_05b_lora_%j.err
...
${PYTHON} -m llamafactory.cli train /share/home/gpu093197/zanewang/project-llm/llamafactory/configs/train_qwen15_05b_lora.yaml
