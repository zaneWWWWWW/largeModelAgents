#!/bin/bash
#SBATCH --job-name=llf_qwen15_05b_dora
#SBATCH --output=llf_qwen15_05b_dora_%j.out
#SBATCH --error=llf_qwen15_05b_dora_%j.err
...
${PYTHON} -m llamafactory.cli train /share/home/gpu093197/zanewang/project-llm/llamafactory/configs/train_qwen15_05b_dora.yaml
