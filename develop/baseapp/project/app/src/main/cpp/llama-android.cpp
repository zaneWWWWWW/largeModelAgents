...
// 全局消息历史 - 参考示例代码
static std::vector<std::string> global_str_storage;  // 存储字符串内容
...
static void add_message_to_history(const char* role, const char* content) {
    // 存储字符串
    global_str_storage.push_back(role);
    global_str_storage.push_back(content);
...
Java_com_example_project_LLamaAPI_load_1model(JNIEnv *env, jobject thiz, jstring filename) {
...
Java_com_example_project_LLamaAPI_free_1model(JNIEnv *env, jobject thiz, jlong model) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_example_project_LLamaAPI_new_1context(JNIEnv *env, jobject thiz, jlong jmodel) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_project_LLamaAPI_free_1context(JNIEnv *env, jobject thiz, jlong context) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_project_LLamaAPI_backend_1free(JNIEnv *env, jobject thiz) {
    llama_backend_free();
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_project_LLamaAPI_log_1to_1android(JNIEnv *env, jobject thiz) {
...
Java_com_example_project_LLamaAPI_bench_1model(JNIEnv *env,
                                                 jobject thiz,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_example_project_LLamaAPI_new_1batch(JNIEnv *env, jobject thiz, jint n_tokens, jint embd,
                                               jint n_seq_max) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_project_LLamaAPI_free_1batch(JNIEnv *env, jobject thiz, jlong batch_pointer) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_example_project_LLamaAPI_new_1sampler(JNIEnv *env, jobject thiz, jfloat temp) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_project_LLamaAPI_free_1sampler(JNIEnv *env, jobject thiz, jlong sampler_pointer) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_project_LLamaAPI_backend_1init(JNIEnv *env, jobject thiz, jboolean numa) {
    ggml_backend_load_all();
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_project_LLamaAPI_system_1info(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(llama_print_system_info());
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_example_project_LLamaAPI_completion_1init(JNIEnv *env,
                                                     jobject thiz,
                                                     jlong context_pointer,
                                                     jlong batch_pointer,
                                                     jstring jtext,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_project_LLamaAPI_completion_1loop(JNIEnv *env, jobject thiz,
    ...
    if (global_messages.size() >= 2) {
        ...
        // 更新内容
        global_str_storage[last_index * 2 + 1] = current_content;
        
        // 更新指针
        global_messages[last_index].content = global_str_storage[last_index * 2 + 1].c_str();
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_project_LLamaAPI_kv_1cache_1clear(JNIEnv *env, jobject thiz, jlong context) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_project_LLamaAPI_get_1kv_1cache_1used(JNIEnv *env, jobject thiz, jlong context_pointer) {
    const auto context = reinterpret_cast<llama_context *>(context_pointer);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_project_LLamaAPI_get_1context_1size(JNIEnv *env, jobject thiz, jlong context_pointer) {
    const auto context = reinterpret_cast<llama_context *>(context_pointer);
...
Java_com_example_project_LLamaAPI_can_1fit_1in_1kv_1cache(JNIEnv *env, jobject thiz,
                                                           jlong context_pointer,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_project_LLamaAPI_incremental_1chat_1completion(JNIEnv *env,
                                                                 jobject thiz,
                                                                 jlong context_pointer,
                                                                 jlong batch_pointer,
                                                                 jlong model_pointer,
    ...
    // 获取ChatMessage类和方法
    jclass chatMessageClass = env->FindClass("com/example/project/LLamaAPI$ChatMessage");
    if (!chatMessageClass) {
    ...
    if (n_kv_req > (size_t)n_ctx) {
        ...
        // 清理刚才添加的消息
        if (global_messages.size() >= 2) {
            global_messages.pop_back(); // 移除空的assistant消息
            global_messages.pop_back(); // 移除用户消息
        }
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_project_LLamaAPI_chat_1completion_1init(JNIEnv *env,
                                                           jobject thiz,
                                                           jlong context_pointer,
                                                           jlong batch_pointer,
                                                           jlong model_pointer,
